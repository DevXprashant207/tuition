function HomeAboutUs() {
  return (
    <section id="about-us" className="relative py-20 px-4 md:px-0 bg-[#f8f6f2] flex justify-center items-center">
      <div className="max-w-5xl w-full mx-auto bg-white rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden">
        <div className="flex-1 p-10 flex flex-col justify-center">
          ...
          <p className="text-[#4e3b19] text-lg leading-relaxed mb-8">
          ...
          <div className="mt-8 mb-2">
            <span className="block text-3xl font-signature text-[#23293a] mb-2" style={{ fontFamily: 'Dancing Script, cursive' }}>Naman Gupta</span>
            <span className="block text-xs tracking-widest text-[#23293a]">CEO &amp; Founder of Gupta Law Firm</span>
          </div>
        </div>
