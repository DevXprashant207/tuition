...
function Footer() {
    ...
    <footer className="bg-[#232220] text-[#bfa77a] pt-16 pb-8 px-4 font-serif">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-[#35332f]">
        <div className="flex flex-col items-start gap-2">
          ...
          <span className="font-bold text-lg tracking-wide text-[#cfac33]">Gupta Law offices</span>
        </div>
        <div>
          <h3 className="text-white text-lg mb-3 font-semibold">Contact Info</h3>
          <ul className="space-y-2 text-[#cfac33]">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:underline text-[#cfac33]">Practice Areas</a></li>
            <li><a href="#" className="hover:underline text-[#cfac33]">Privacy & Policy</a></li>
            <li><a href="#" className="hover:underline text-[#cfac33]">Our Story</a></li>
            <li><a href="#" className="hover:underline text-[#cfac33]">Be Our Partner</a></li>
          </ul>
        </div>
        <div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between pt-6">
        <div className="flex gap-6 text-[#cfac33] text-2xl mb-2 md:mb-0">
          {/* Social icons here */}
  ...
  <div className="text-[#cfac33] text-sm">Copyright © 2025 Gupta Law offices, All Rights Reserved</div>
